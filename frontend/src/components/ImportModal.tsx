          ...
          {!file && !isImporting && !isCompleted && (
            <div className="space-y-4">
              <div className="border-2 border-dashed border-brand-500/30 dark:border-brand-500/20 rounded-3xl p-10 text-center hover:border-brand-500 bg-brand-500/5 transition-all">
                ...
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 mt-1">Required columns: <code className="bg-gray-200 dark:bg-gray-800 px-1.5 py-0.5 rounded font-mono text-[11px] text-brand-600 dark:text-brand-300">REG NO</code>, <code className="bg-gray-200 dark:bg-gray-800 px-1.5 py-0.5 rounded font-mono text-[11px] text-brand-600 dark:text-brand-300">NAME</code>, <code className="bg-gray-200 dark:bg-gray-800 px-1.5 py-0.5 rounded font-mono text-[11px] text-brand-600 dark:text-brand-300">DEPT</code>, <code className="bg-gray-200 dark:bg-gray-800 px-1.5 py-0.5 rounded font-mono text-[11px] text-brand-600 dark:text-brand-300">YEAR</code>, <code className="bg-gray-200 dark:bg-gray-800 px-1.5 py-0.5 rounded font-mono text-[11px] text-brand-600 dark:text-brand-300">LEETCODE PROFILE LINK</code></p>
                <input
                  type="file"
                  accept=".xlsx, .xls"
                  onChange={handleFileChange}
                  className="mt-6 block w-full text-xs text-gray-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-xs file:font-black file:bg-brand-600 file:text-white hover:file:bg-brand-700 cursor-pointer mx-auto max-w-xs transition-all shadow-md"
                />
              </div>
