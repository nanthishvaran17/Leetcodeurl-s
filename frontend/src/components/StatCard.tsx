...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  if (loading) {
    return (
      <div className="glass-card p-5 rounded-2xl border border-gray-200 dark:border-navy-800 animate-pulse">
  ...
  return (
    <div className="glass-card p-5 rounded-2xl border border-gray-200/80 dark:border-navy-800/80 card-ai-control group cursor-pointer relative overflow-hidden">
      <div className="flex items-center justify-between">
        <div>
        ...
        <div className={`p-3 rounded-2xl bg-gradient-to-tr border transition-all duration-300 ${colorStyles[color]}`}>
