              ...
              <>
                ...
                <div className="flex items-center justify-end space-x-3 pt-2">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-white text-xs font-bold shadow-md transition-all cursor-pointer transform hover:scale-[1.01] ${confirmModal.type === 'delete_staff' ? 'bg-rose-600 hover:bg-rose-700' : 'bg-sky-700 hover:bg-sky-800'
                      }`}
                  >
