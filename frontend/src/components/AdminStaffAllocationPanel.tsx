...
export const AdminStaffAllocationPanel: React.FC = () => {
  ...
  return (
    <div className="space-y-8 font-serif" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
      ...
      <div className="bg-white dark:bg-navy-900 p-6 rounded-3xl border border-slate-200 dark:border-navy-700 shadow-xl space-y-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-navy-400 font-serif">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-sky-700 hover:bg-sky-800 text-white text-xs font-bold font-serif flex items-center space-x-2 shadow-md transition-all cursor-pointer transform hover:scale-[1.01]"
            >
            ...
            <button
              ...
              disabled={submitting}
              className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-navy-800 hover:bg-slate-200 dark:hover:bg-navy-700 text-slate-700 dark:text-slate-200 text-xs font-bold font-serif flex items-center space-x-2 border border-slate-200 dark:border-navy-700 transition-all cursor-pointer"
            >
          ...
          <div className="flex items-center space-x-3 flex-wrap gap-2 flex-1">
            <div className="relative min-w-[200px] flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-1.5 rounded-xl border border-slate-200 dark:border-navy-600 bg-white dark:bg-navy-900 text-xs font-serif text-slate-800 dark:text-slate-200 outline-none focus:border-sky-500"
              />
            </div>
            ...
            <div className="flex items-center space-x-1.5 bg-white dark:bg-navy-900 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-navy-600">
              ...
              <select
                ...
                className="bg-transparent text-xs font-bold font-serif text-slate-700 dark:text-slate-200 outline-none cursor-pointer"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {loading ? (
            <p className="text-xs text-slate-500 animate-pulse font-serif">Loading staff workload...</p>
          ) : filteredStaffList.length === 0 ? (
            <p className="text-xs text-slate-400 italic font-serif">No staff accounts match the filter criteria.</p>
          ) : (
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-extrabold text-sm text-slate-900 dark:text-white flex items-center space-x-2 font-serif">
                        <span>{st.username}</span>
                        {!st.is_active ? (
                          <span className="px-2 py-0.5 rounded text-[10px] font-black bg-rose-500/20 text-rose-500 font-serif">
                            ● DISABLED
                          </span>
                        ) : isFull ? (
                          <span className="px-2 py-0.5 rounded text-[10px] font-black bg-rose-500/20 text-rose-600 font-serif">
                            ● CAPACITY FULL
                          </span>
                        ) : (
                          <span className="px-2 py-0.5 rounded text-[10px] font-black bg-emerald-500/20 text-emerald-600 font-serif">
                            ● AVAILABLE
                          </span>
                        )}
                      </h4>
                      <div className="flex items-center space-x-2 mt-0.5">
                        <p className="text-xs text-slate-400 font-serif">{st.email}</p>
                        {st.department && (
                          <span className="px-2 py-0.5 rounded bg-sky-50 dark:bg-sky-500/10 text-sky-700 dark:text-sky-400 text-[9px] font-bold font-serif border border-sky-100 dark:border-sky-500/20">
                            {st.department}
                          </span>
                        )}
                      </div>
                  ...
                  <div className="mt-4 space-y-1.5">
                    <div className="flex justify-between text-xs font-bold text-slate-500 font-serif">
                    ...
                    <div className="flex justify-between items-center text-[11px] text-slate-400 font-serif pt-0.5">
                      <button
                        onClick={() => handleOpenStaffRoster(st)}
      ...
      <div className="bg-white dark:bg-navy-900 p-6 rounded-3xl border border-slate-200 dark:border-navy-700 shadow-xl space-y-6 font-serif">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <h3 className="text-base font-black text-slate-800 dark:text-slate-100 flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-3 flex-wrap gap-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-xs font-bold font-serif flex items-center space-x-2 shadow-md transition-all cursor-pointer transform hover:scale-[1.01]"
            >
        ...
        <div className="p-4 rounded-2xl bg-slate-50 dark:bg-navy-800/60 border border-slate-200 dark:border-navy-700 flex flex-wrap items-center justify-between gap-3 font-serif">
          ...
          <div className="flex items-center space-x-3 flex-wrap gap-2 flex-1">
            <div className="relative min-w-[200px] flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 rounded-xl border border-slate-200 dark:border-navy-600 bg-white dark:bg-navy-900 text-xs font-serif text-slate-800 dark:text-slate-200 outline-none focus:border-sky-500"
              />
            </div>
            ...
            {isFilterActive && (
              <button
                ...
                className="p-2 rounded-xl bg-slate-200 dark:bg-navy-700 hover:bg-slate-300 dark:hover:bg-navy-600 text-slate-600 dark:text-slate-300 text-xs flex items-center space-x-1 transition-all cursor-pointer font-serif"
          ...
          <div className="flex items-center space-x-2">
            <select
              ...
              className="px-3 py-2 rounded-xl border border-slate-200 dark:border-navy-600 bg-white dark:bg-navy-900 text-xs font-bold font-serif text-slate-700 dark:text-slate-200 outline-none cursor-pointer"
            >
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-sky-700 hover:bg-sky-800 disabled:opacity-50 text-white text-xs font-bold font-serif flex items-center space-x-1 shadow-md transition-all cursor-pointer"
            >
        ...
        <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-navy-700 font-serif">
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-navy-800 font-serif">
              {loading ? (
                <tr>
                  <td colSpan={7} className="p-4 text-center text-slate-500 animate-pulse font-serif">
                    Loading unassigned students...
                  </td>
                </tr>
              ) : filteredUnassigned.length === 0 ? (
                <tr>
                  <td colSpan={7} className="p-6 text-center text-slate-400 italic font-serif">
                ...
                filteredUnassigned.map((st: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-3 font-mono font-bold text-slate-800 dark:text-slate-200">{st.reg_no}</td>
                      <td className="p-3 font-extrabold text-slate-900 dark:text-white font-serif">{st.name}</td>
                      <td className="p-3 font-bold text-sky-700 dark:text-sky-400 font-serif">{st.department || 'CSE'}</td>
                      <td className="p-3 text-slate-600 dark:text-navy-300 font-serif">{st.year_level || 'III'}</td>
                      <td className="p-3 font-mono text-slate-500 dark:text-navy-400">{st.username || '—'}</td>
                      <td className="p-3 text-right font-bold text-slate-800 dark:text-slate-200 font-serif">
                        {st.total_solved || 0}
                      </td>
                    </tr>
                  );
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in font-serif">
          <div className="bg-white dark:bg-navy-900 w-full max-w-3xl p-6 rounded-3xl border border-slate-200 dark:border-navy-700 shadow-2xl space-y-5 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-navy-800 pb-3">
              <div>
                <h3 className="font-extrabold text-base text-slate-900 dark:text-white flex items-center space-x-2 font-serif">
            ...
            {viewRosterModal.loading ? (
              <div className="text-center py-8 space-y-3 font-serif">
                      ...
                      {viewRosterModal.data.students?.length === 0 ? (
                        ...
                        viewRosterModal.data.students?.map((s: any) => (
                          <tr key={s.id} className="hover:bg-slate-50 dark:hover:bg-navy-800/50">
                            <td className="p-3 font-mono font-bold text-slate-800 dark:text-slate-200">{s.reg_no}</td>
                            ...
                            <td className="p-3 font-mono text-sky-700 dark:text-sky-400">{s.username || '—'}</td>
      ...
      {confirmModal.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in font-serif">
          <div className="bg-white dark:bg-navy-900 w-full max-w-md p-6 rounded-3xl border border-slate-200 dark:border-navy-700 shadow-2xl space-y-5">
            ...
            {confirmModal.result ? (
              <div className="space-y-4 py-2 text-center font-serif">
                ...
                <button
                  onClick={() => setConfirmModal({ isOpen: false, type: null, title: '', description: '' })}
                  className="w-full py-2.5 rounded-xl bg-sky-700 hover:bg-sky-800 text-white font-serif font-bold text-xs shadow-md cursor-pointer"
                >
                  Close & View Assignments
                </button>
              </div>
            ) : confirmModal.processing ? (
              <div className="text-center py-6 space-y-3 font-serif">
                <RefreshCw className="w-8 h-8 text-sky-600 animate-spin mx-auto" />
                <p className="text-xs font-bold text-slate-800 dark:text-white font-serif">Processing operation...</p>
                <p className="text-[11px] text-slate-500 font-serif">Please wait while database allocations update.</p>
              </div>
            ) : (
              <>
                <p className="text-xs text-slate-600 dark:text-navy-300 font-serif leading-relaxed">
                ...
                {confirmModal.type === 'delete_staff' && confirmModal.targetStaff && (
                  <div className="p-3 rounded-2xl bg-rose-50 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/50 text-xs text-rose-700 dark:text-rose-300 font-serif space-y-1">
                ...
                <div className="flex items-center justify-end space-x-3 pt-2 font-serif">
                  <button
                    type="button"
                    onClick={() => setConfirmModal({ isOpen: false, type: null, title: '', description: '' })}
                    className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-navy-800 text-slate-700 dark:text-slate-300 text-xs font-bold font-serif cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-white text-xs font-bold font-serif shadow-md transition-all cursor-pointer transform hover:scale-[1.01] ${
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in font-serif">
          <div className="bg-white dark:bg-navy-900 w-full max-w-md p-6 rounded-3xl border border-slate-200 dark:border-navy-700 shadow-2xl space-y-4">
            ...
            <form onSubmit={handleCreateStaff} className="space-y-4 text-xs font-medium font-serif">
              <div>
                <label className="block text-slate-700 dark:text-slate-300 font-bold mb-1 font-serif">Username / Name</label>
                <input
                  type="text"
                  value={newUsername}
                  onChange={(e) => setNewUsername(e.target.value)}
                  placeholder="e.g. Dr. K. Anand"
                  className="w-full p-2.5 rounded-xl border border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-950 text-slate-900 dark:text-white outline-none focus:border-sky-500 font-serif"
                  required
                />
              </div>

              <div>
                <label className="block text-slate-700 dark:text-slate-300 font-bold mb-1 font-serif">Official Email</label>
                <input
                  type="email"
                  value={newEmail}
              ...
              <div>
                <label className="block text-slate-700 dark:text-slate-300 font-bold mb-1 font-serif">Initial Password</label>
                <input
                  type="text"
                  value={newPassword}
                  onChange={(e) => setNewPassword(e.target.value)}
                  className="w-full p-2.5 rounded-xl border border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-950 text-slate-900 dark:text-white outline-none focus:border-sky-500 font-mono"
                  required
                />
              </div>

              <div>
                <label className="block text-slate-700 dark:text-slate-300 font-bold mb-1 font-serif">Department</label>
                <select
                  value={newDeptId}
                  onChange={(e) => setNewDeptId(Number(e.target.value))}
                  className="w-full p-2.5 rounded-xl border border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-950 text-slate-900 dark:text-white outline-none cursor-pointer font-serif"
                >
                  {departments.map((d: any) => (
              ...
              <div className="flex items-center justify-end space-x-3 pt-2 font-serif">
                <button
                  type="button"
                  onClick={() => setShowCreateModal(false)}
                  className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-navy-800 text-slate-700 dark:text-slate-300 font-bold font-serif cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-4 py-2 rounded-xl bg-sky-700 hover:bg-sky-800 text-white font-bold font-serif disabled:opacity-50 cursor-pointer"
                >
