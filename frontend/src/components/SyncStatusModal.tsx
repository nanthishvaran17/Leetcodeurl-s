      ...
      <div className="modal-container-responsive max-w-lg bg-white dark:bg-navy-950 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-lg animate-modal-content">
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-navy-950 border border-slate-200 dark:border-navy-800 space-y-2.5">
                ...
                {/* Progress Bar Track */}
                <div className="w-full h-3 bg-slate-200 dark:bg-navy-800 rounded-full overflow-hidden p-0.5 border border-slate-300/50 dark:border-navy-700">
                  <div
                      ...
                      return (
                        <div key={idx} className="flex items-center justify-between text-[10.5px] py-0.5 border-b border-slate-800/60 last:border-0">
                          <div className="flex items-center space-x-2 truncate">
                            ...
                            {rec.username && (
                              <span className="text-slate-500 text-[10px]">@{rec.username}</span>
                            )}
                          </div>
        ...
        <div className="flex items-center justify-between p-4 border-t border-slate-100 dark:border-navy-800 bg-slate-50/50 dark:bg-navy-950/50 shrink-0">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2 bg-slate-100 dark:bg-navy-800 hover:bg-slate-200 dark:hover:bg-navy-700 text-slate-900 dark:text-white rounded-xl text-xs font-extrabold transition-colors cursor-pointer"
          >
