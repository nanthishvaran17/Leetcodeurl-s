...
export const ConfirmDeleteModal: React.FC<ConfirmDeleteModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-[#07111E]/75 backdrop-blur-md overflow-hidden animate-fadeIn"
      onClick={(e) => {
    ...
    >
      <div
        className="relative w-full max-w-[460px] max-h-[88vh] bg-slate-900 border border-slate-700/80 rounded-3xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] border-t-[3.5px] border-t-rose-500 flex flex-col overflow-hidden transform transition-all animate-scaleUp text-white my-auto"
