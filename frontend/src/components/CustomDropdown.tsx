      ...
      <AnimatePresence>
        {isOpen && (
            <motion.div
              ...
              className={`absolute ${alignClass} z-[9999] mt-1.5 ${popoverWidth} max-h-80 overflow-y-auto rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.4),0_0_0_1px_rgba(0,0,0,0.08)] p-1.5 space-y-1 focus:outline-none`}
            >
