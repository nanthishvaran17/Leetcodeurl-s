...
def run_db_migrations():
    ...
    if "postgresql" in _db_url or "postgres" in _db_url:
        pg_migrations = [
            ...
            "ALTER TABLE students ADD COLUMN IF NOT EXISTS institutional_email VARCHAR(150)",
            "ALTER TABLE students ADD COLUMN IF NOT EXISTS email_status VARCHAR(50) DEFAULT 'pending'",
            "ALTER TABLE students ADD COLUMN IF NOT EXISTS allocation VARCHAR(50)",
