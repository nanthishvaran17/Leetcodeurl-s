...
class WeeklyPublicResult(Base):
    ...
    q1_observed_seconds = Column(Integer, nullable=True)
    q2_observed_seconds = Column(Integer, nullable=True)
    q3_observed_seconds = Column(Integer, nullable=True)
    q4_observed_seconds = Column(Integer, nullable=True)
