        ...
        for reg, name, dept_code, yr, sec_name, email, url, d_id, s_id in all_students:
            try:
                ...
                profile_stats_map = {
                    ...
                    "732225CI056": (33,  15,  17,  1,   None,   3405027), # THAMARAIKANNAN M R (thamaraikannan_mr_2007)
                ...
                if reg in profile_stats_map:
                    tot, ez, med, hd, c_rating, c_rank = profile_stats_map[reg]
                    st_status = "OK"
                else:
                    tot, ez, med, hd = 0, 0, 0, 0
                    c_rating, c_rank = None, None
                    st_status = "NOT STARTED" if not url else "OK"
